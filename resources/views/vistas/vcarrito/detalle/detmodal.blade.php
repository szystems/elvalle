<!-- Basic Modals -->
		<div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="modal-det-{{$detalle->idorden_detalle}}">
            {{Form::open(array
				(
					'action' => 'VistaCarritoController@detallemodal',
                    'method' => 'GET',
                    'role' => 'form',
				))
			}}
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Editar Cantidad de Productos de Detalle</h5>
					...
					<div class="modal-body">
						...
						<h5 class="modal-title" id="exampleModalLabel"><br> Producto: {{ $detalle->articulo}}</br></h5>
						<br>
						<h4>Cantidad:</h4>
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-info"><i class="glyphicon glyphicon-ok"></i> Confirmar</button>
