...
<div class="col-md-6 mb-4">
      <div class="card">
            <header class="card-header">
                  <h2 class="h3 card-header-title"><strong>Editar Doctor: {{ $doctor->name}} </strong></h2>
            </header>
            ...
            <div class="card-body">
                  ...
                  {!!Form::model($doctor,['method'=>'PATCH','route'=>['doctor.update',$doctor->id],'files'=>'true'])!!}
                  {{Form::token()}}
                  ...
                  <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                        ...
                        <input id="telefono" type="text" class="form-control" name="telefono" value="{{$doctor->telefono}}">
                  ...
                  <div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }}">
                        ...
                        <input id="direccion" type="text" class="form-control" name="direccion" value="{{$doctor->direccion}}">
                  ...
                  <div class="form-group{{ $errors->has('contacto_emergencia') ? ' has-error' : '' }}">
                        ...
                        <input id="contacto_emergencia" type="text" class="form-control" name="contacto_emergencia" value="{{$doctor->contacto_emergencia}}" placeholder="Contacto de Emergencia">
                  ...
                  <div class="form-group{{ $errors->has('telefono_emergencia') ? ' has-error' : '' }}">
                        ...
                        <input id="telefono_emergencia" type="text" class="form-control" name="telefono_emergencia" value="{{$doctor->telefono_emergencia}}" placeholder="Teléfono del contacto de emergencia">
                  ...
                  <div class="form-group">
                        ...
                        @if (($doctor->foto)!="")
                               <img src="{{asset('imagenes/usuarios/'.$doctor->foto)}}" height="300px" >
                        @endif
                  </div>
                  ...
                  <div class="form-group{{ $errors->has('tipo_usuario') ? ' has-error' : '' }}">
                        ...
                        <select id="tipo_usuario" type="text" class="form-control" name="tipo_usuario">
                            <option selected="selected" value="{{$doctor->tipo_usuario}}">{{$doctor->tipo_usuario}}</option>  
                        </select>
                  ...
                  <div class="form-group{{ $errors->has('especialidad') ? ' has-error' : '' }}">
                        ...
                        <select id="especialidad" type="text" class="form-control" name="especialidad">
                              <option selected="selected" value="{{$doctor->especialidad}}">{{$doctor->especialidad}}</option> 
                              <option value="Ginecólogo y Obstetra">Ginecólogo y Obstetra</option>
                  ...
                  <div class="form-group{{ $errors->has('max_descuento') ? ' has-error' : '' }}">
                        ...
                        <input type="number" name="max_descuento" class="form-control" id="max_descuento" value="{{$doctor->max_descuento}}" onkeypress="return validarentero(event,this.value)">
                  ...
                  <div class="form-group{{ $errors->has('activo') ? ' has-error' : '' }}">
                        ...
                        <label class="d-flex align-items-center justify-content-between">
                              ...
                              <div class="form-toggle">
                                    ...
                                    @else
                                          <input name="activo" type="checkbox" value="SI">
                                    @endif
