<html html>
	...
	<body>
		...
		<h6>
			...
			<br><strong>Doctor:</strong><font color="Blue"> <strong>{{ $colposcopia->Paciente}}<strong></font>
			<br><strong>Paciente:</strong><font color="Blue"> <strong>{{ $colposcopia->Doctor}} ({{ $colposcopia->especialidad }})<strong></font>
