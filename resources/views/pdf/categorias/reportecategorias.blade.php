<html html>
	<head>
  		<title>Listado de Categorías SZ-Ventas</title>
		<style>
		  	h1, h2, h3, h4, h5, h6 {
	...
	<body>
		...
		<h4 align="center">
			<strong><u>Listado de Categorías</u></strong>
		</h4>
		<h6>
		...
		<table>
			...
			<tr>
				<td><h4 align="center">{{ $cat->nombre}}</h4></td>
				<td><h4 align="center">{{ $cat->descripcion}}</h4></td>
			</tr>
			@endforeach
		</table>
		<br>
