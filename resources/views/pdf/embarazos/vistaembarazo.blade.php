<html html>
	...
	<body>
		...
		<h6>
			...
			<br><strong>Doctor:</strong><font color="Blue"> <strong>{{ $embarazo->Paciente}}<strong></font>
			<br><strong>Paciente:</strong><font color="Blue"> <strong>{{ $embarazo->Doctor}} ({{ $embarazo->especialidad }})<strong></font>
