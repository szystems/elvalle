<!-- Basic Modals -->
		<div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="modal-delete-{{$ven->idventa}}">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						Confirme si desea cancelar la venta ID: {{$ven->idventa}}, los articulos seran devueltos al stock.
					</div>
