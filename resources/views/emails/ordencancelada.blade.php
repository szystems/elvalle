                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            ...
                                                                                                                            <strong><font font color="black"><h1>Orden Cancelada</h1></font></strong
                                                                                                                                <strong><font font color="black">Tu orden fue cancelada, los datos son los siguientes:</font></strong>
                                                                                                                            </span>
                                                                                                                            <ul>
                                                                                                                                <li>Codigo de Orden: {{ $orden->codigo }}</li>
                                                                                                                                <li>Nombre: {{ $cliente->name }}</li>
                                                                                                                                <li>Usuario: {{ $cliente->email }}</li>
                                                                                                                                ...
                                                                                                                                <li>Total: {{ $cliente->moneda }}{{ number_format($orden->total,2, '.', ',') }}</li>
                                                                                                                                <li>Envío : {{ $datosConfig->moneda }}{{ number_format($orden->envio,2, '.', ',') }}</li>
                                                                                                                                <li>*{{ $datosConfig->descripcion_envio }}</li>
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">Para cualquier consulta o comentario dirígete a nuestra web en el siguiente link: </span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
