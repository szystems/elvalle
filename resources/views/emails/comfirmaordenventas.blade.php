                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            ...
                                                                                                                            <strong><font font color="black"><h1>Orden confirmada </h1></font></strong
                                                                                                                                <strong><font font color="black">Un cliente acaba de confirmar una orden, los datos son los siguientes:</font></strong>
                                                                                                                            </span>
                                                                                                                            <ul>
                                                                                                                                ...
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">Para darle seguimiento a la orden de compra inicia sesión con tu cuenta desde la pagina:</span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
