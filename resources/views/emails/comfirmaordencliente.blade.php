                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    <td valign="top" align="left" name="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left;" class="tblCell">
                                                                                                                        <div style="line-height: 150%; text-align: center;">
                                                                                                                            ...
                                                                                                                            <strong><font font color="black"><h1>Orden </h1></font></strong
                                                                                                                                <strong><font font color="black">Tu orden fue confirmada, en unos momentos recibirás noticias de un encargado para terminar de realizar tu compra, los detalles son los siguientes:</font></strong>
                                                                                                                            </span>
                                                                                                                            <ul>
                                                                                                                                <li>Codigo de Orden: {{ $orden->codigo }}</li>
                                                                                                                                <li>Fecha: {{ $orden->fecha_update }}</li>
                                                                                                                                <li>Nombre Contacto: {{ $orden->nom_contacto }}</li>
                                                                                                                                <li>Email Contacto: {{ $orden->email_contacto }}</li>
                                                                                                                                <li>Telefono Contacto: {{ $orden->telefono_contacto }}</li>
                                                                                                                                <li>Whatsapp Contacto: {{ $orden->whatsapp_contacto }}</li>
                                                                                                                                <li>Direccion: {{ $orden->direccion }}, {{$orden->municipio}}, {{$orden->departamento}}, {{$orden->pais}}</li>
                                                                                                                                <li>Estado Orden: {{ $orden->estado_orden }}</li>
                                                                                                                                <li>Pago: {{$orden->tipo_pago}} ({{ $orden->estado_pago }})</li>
                                                                                                                                @if($orden->link_pago != null)
                                                                                                                                <li>Link de pago: {{ $orden->link_pago }}</li>
                                                                                                                                @endif
                                                                                                                                <li>Comentarios: {{ $orden->comentarios }}</li>
                                                                                                                                <li>Total: {{ $datosConfig->moneda }}{{ number_format($orden->total,2, '.', ',') }}</li>
                                                                                                                                <li>Envío : {{ $datosConfig->moneda }}{{ number_format($orden->envio,2, '.', ',') }}</li>
                                                                                                                                <li>*{{ $datosConfig->descripcion_envio }}</li>
                                                                                                                                <br><span style="font-size: 14px; font-family: 'Courier New', Courier; color: #464646; line-height: 150%;">Para continuar viendo las actualizaciones de tu compra o contactarse con un vendedor ve a nuestra página e inicia sesión con tu cuenta: </span>
                                                                                                                            </ul>
                                                                                                                        </div>
                                                                                                                    </td>
                                                                                                                </tr>
