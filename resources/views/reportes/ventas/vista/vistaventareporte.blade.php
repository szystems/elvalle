<html html>
	...
	<body>
		...
		<h6>
			...
			@endif
			<br><strong>Costo Total:</strong><font color="Red"> <strong>{{ Auth::user()->moneda }}{{ number_format($venta->total_compra,2, '.', ',')}}<strong></font>
			<br><strong>Diferencia:</strong><font color="Green"> <strong>{{ Auth::user()->moneda }}{{ number_format($venta->total_venta-$venta->total_compra,2, '.', ',')}}<strong></font>
			<br><strong>Venta Total:</strong><font color="Blue"> <strong>{{ Auth::user()->moneda }}{{ number_format($venta->total_venta,2, '.', ',')}}<strong></font>
			<br><strong>Vendedor:</strong><font color="orange"> <strong>{{ $venta->name}}<strong></font>
			<br><strong>Comision Total:</strong><font color="orange"> <strong>{{ Auth::user()->moneda }}{{ number_format($venta->total_comision,2, '.', ',')}}<strong></font>
			<br><strong>Estado Venta:</strong><font color="orange"> <strong>{{ $venta->estadoventa}}<strong></font>
			<br><strong>Tipo Pago:</strong><font color="orange"> <strong>{{ $venta->tipopago}}<strong></font>
		</h6>
		<h4 align="left">
