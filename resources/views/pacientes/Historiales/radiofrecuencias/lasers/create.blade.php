            ...
            <div class="card mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="card">
                              ...
                              <header class="card-header">
                                    <h2 class="h3 card-header-title"><strong>Nueva sesion de laser: </strong></h2>
                              </header>

                              <div class="card-body">
                                    {!! Form::open(['url' => 'pacientes/historiales/radiofrecuencias/lasers', 'method' => 'POST', 'autocomplete' => 'off']) !!}
                                    {{ Form::token() }}
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                                      <div class="form-group">
                                                            <label for="doctor"><h2><u><strong>Datos de nueva sesion de laser:</strong></u></h2></label>
                                                      </div>
                                                </div>
                                                                  ...
                                                                  <table class="table table-sm table-striped table-bordered table-condensed table-hover">
                                                                        ...
                                                                        <tbody>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <textarea class="form-control" name="area" cols="30" rows="2">{{ old('area') }}</textarea>
                                                                                          </div>
                                                                                    </td>
                                                                              </tr>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <textarea class="form-control" name="zonas_a_tratar" cols="30" rows="2">{{ old('zonas_a_tratar') }}</textarea>
                                                                                          </div>
                                                                                    </td>
                                                                              </tr>

                                                                              <tr>
                                                                                    <td><strong>Paramentros</strong></td>
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <textarea class="form-control" name="parametros" cols="30" rows="2">{{ old('parametros') }}</textarea>
                                                                                          </div>
                                                                                    </td>
                                                                              </tr>
