            ...
            <div class="card mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="card">
                              ...
                              <header class="card-header">
                                    <h2 class="h3 card-header-title"><strong>Editar sesion de laser: </strong></h2>
                              </header>
                              ...
                              <div class="card-body">
                                    ...
                                    {{Form::token()}}
                                          <div class="row">
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                                      <div class="form-group">
                                                            <label for="doctor"><h2><u><strong>Editar datos de sesion de laser:</strong></u></h2></label>
                                                      </div>
                                                </div>
                                                                  ...
                                                                  <table class="table table-sm table-striped table-bordered table-condensed table-hover">
                                                                        ...
                                                                        <tbody>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                      <select name="tipo" class="form-control">
                                                                                                            @if ($sesion->tipo)
                                                                                                                  <option value="{{ $sesion->tipo }}" selected>{{ $sesion->tipo }}</option>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <textarea class="form-control" name="area" cols="30" rows="2">{{ $sesion->area }}</textarea>
                                                                                          </div>
                                                                                    </td>
                                                                              </tr>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <textarea class="form-control" name="zonas_a_tratar" cols="30" rows="2">{{ $sesion->zonas_a_tratar }}</textarea>
                                                                                          </div>
                                                                                    </td>
                                                                              </tr>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <textarea class="form-control" name="parametros" cols="30" rows="2">{{ $sesion->parametros }}</textarea>
                                                                                          </div>
                                                                                    </td>
                                                                              </tr>
