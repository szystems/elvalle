                ...
                <div class="card">
                    ...
                    <header class="card-header">
                        <a href="{{URL::action('UltrasonidoObstetricoController@show',$ultrasonido->idultrasonido_obstetrico)}}">
                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Regresar a examen ultrasonido">
                                <button class="btn btn-sm btn-info" style="pointer-events: none;" type="button">
                                    <i class="fas fa-reply-all"></i>Regresar ultrasonido obstetrico
                                </button>
                            </span>
                        </a>
                        ...
                        @if(Auth::user()->tipo_usuario == "Doctor")
                            {!!Form::open(array('url'=>'pacientes/historiales/ultrasonidos/imagenes','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
                            {{Form::token()}}
                            ...
                            <div class="input-group">
                                <div class="col-lg-4 col-sm-12 col-md-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="idultrasonido_obstetrico" class="form-control" value="{{$ultrasonido->idultrasonido_obstetrico}}">
                                    </div>
                                </div>
                                    <div class="col-lg-4 col-sm-12 col-md-12 col-xs-12">
                                        <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered table-condensed table-hover">
                                ...
                                @foreach ($ultrasonidoimgs as $imagen)
                                    <tr>
                                        <td>
                                            @if(Auth::user()->tipo_usuario == "Doctor")
                                                <a href="{{URL::action('UltrasonidoObstetricoImgController@edit',$imagen->idultrasonido_obstetrico_img)}}">
                                                ...
                                                <a href="" data-target="#modal-eliminar-{{$imagen->idultrasonido_obstetrico_img}}" data-toggle="modal">
                                        ...
                                        <td align="center">
                                            @if ($imagen->imagen != null)
                                                <img src="{{asset('imagenes/ultrasonidos/'.$imagen->imagen)}}" alt="" width="250px"  class="img-thumbnail">
                                            @else
                                                "No hay imagen"
                                            @endif
                                        </td>
                                    </tr>
                                    @include('pacientes.historiales.ultrasonidos.imagenes.modaleliminar')
                                @endforeach
                            </table>
                        </div>
                    </div>
