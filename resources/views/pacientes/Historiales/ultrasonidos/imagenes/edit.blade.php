            ...
            <div class="card mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="card">
                              ...
                              <header class="card-header">
                                    <h2 class="h3 card-header-title"><strong>Editar Imagen de ultrasonido obstetrico: </strong></h2>
                              </header>

                              <div class="card-body">
                                    {!!Form::model($ultrasonidoimg,['method'=>'PATCH','route'=>['imagenes.update',$ultrasonidoimg->idultrasonido_obstetrico_img],'files'=>'true'])!!}
                                    {{Form::token()}}
                                    <div class="input-group">
                                          <div class="col-lg-3 col-sm-12 col-md-12 col-xs-12">
                                              <div class="form-group">
                                                  <br>
                                                  @if ($ultrasonidoimg->imagen != null)
                                                      <img src="{{asset('imagenes/ultrasonidos/'.$ultrasonidoimg->imagen)}}" alt="" width="250px"  class="img-thumbnail">
                                                  @else
                                                            "No hay imagen"
                                                  @endif
                                              </div>
                                          ...
                                          <div class="col-lg-5 col-sm-12 col-md-12 col-xs-12">
                                                ...
                                                <label for="descripcion">Descripción</label>
                                                      <textarea name="descripcion" class="form-control">{{ $ultrasonidoimg->descripcion }}</textarea>
                                                </div>
                                          </div>
                                      </div>
