                                                                  ...
                                                                  <table class="table table-sm table-striped table-bordered table-condensed table-hover">
                                                                        ...
                                                                        <tbody>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td>
                                                                                          @if (old('embarazo_unico'))
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="embarazo_unico" value="1" checked>
                                                                                                </div>
                                                                                          @else
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="embarazo_unico" value="1">
                                                                                                </div>
                                                                                          @endif
                                                                                          <input type="text" name="embarazo_unico_comentar" class="form-control text-right" value="{{ old('embarazo_unico_comentar') }}">
                                                                                    </td>
                                                                              </tr>
                                                                              <tr>
                                                                                    <td >
                                                                                    ...
                                                                                    <td>
                                                                                          @if (old('alteraciones_crecimiento'))
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="alteraciones_crecimiento" value="1" checked>
                                                                                                </div>
                                                                                          @else
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="alteraciones_crecimiento" value="1">
                                                                                                </div>
                                                                                          @endif
                                                                                          <input type="text" name="alteraciones_crecimiento_comentar" class="form-control text-right" value="{{ old('alteraciones_crecimiento_comentar') }}">
                                                                                    </td>
                                                                              </tr>
                                                                              <tr>
                                                                                    <td >
                                                                                    ...
                                                                                    <td>
                                                                                          @if (old('alteraciones_frecuencia'))
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="alteraciones_frecuencia" value="1" checked>
                                                                                                </div>
                                                                                          @else
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="alteraciones_frecuencia" value="1">
                                                                                                </div>
                                                                                          @endif
                                                                                          <input type="text" name="alteraciones_frecuencia_comentar" class="form-control text-right" value="{{ old('alteraciones_frecuencia_comentar') }}">
                                                                                    </td>
                                                                              </tr>
                                                                              <tr>
                                                                                    <td >
                                                                                    ...
                                                                                    <td>
                                                                                          @if (old('placenta'))
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="placenta" value="1" checked>
                                                                                                </div>
                                                                                          @else
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="placenta" value="1">
                                                                                                </div>
                                                                                          @endif
                                                                                          <input type="text" name="placenta_comentar" class="form-control text-right" value="{{ old('placenta_comentar') }}">
                                                                                    </td>
                                                                              </tr>
                                                                              <tr>
                                                                                    <td >
                                                                                    ...
                                                                                    <td>
                                                                                          @if (old('liquido'))
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="liquido" value="1" checked>
                                                                                                </div>
                                                                                          @else
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="liquido" value="1">
                                                                                                </div>
                                                                                          @endif
                                                                                          <input type="text" name="liquido_comentar" class="form-control text-right" value="{{ old('liquido_comentar') }}">
                                                                                    </td>
                                                                              </tr>
                                                                              <tr>
                                                                                    <td >
                                                                                    ...
                                                                                    <td>
                                                                                          @if (old('prematuro'))
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="prematuro" value="1" checked>
                                                                                                </div>
                                                                                          @else
                                                                                                <div class="primary-checkbox">
                                                                                                      <input type="checkbox" name="prematuro" value="1">
                                                                                                </div>
                                                                                          @endif
                                                                                          <input type="text" name="prematuro_comentar" class="form-control text-right" value="{{ old('prematuro_comentar') }}">
                                                                                    </td>
                                                                              </tr>
                                                                              <tr>
