            ...
            <div class="card mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="card">
                              ...
                              <header class="card-header">
                                    <h2 class="h3 card-header-title"><strong>Editar Imagen de estudio de climaterio y menopausea: </strong></h2>
                              </header>

                              <div class="card-body">
                                    {!!Form::model($climaymenoimg,['method'=>'PATCH','route'=>['imagenes.update',$climaymenoimg->idclimaymeno_img],'files'=>'true'])!!}
                                    {{Form::token()}}
                                    <div class="input-group">
                                          <div class="col-lg-3 col-sm-12 col-md-12 col-xs-12">
                                              <div class="form-group">
                                                  <br>
                                                  @if ($climaymenoimg->imagen != null)
                                                      <img src="{{asset('imagenes/climaymenos/'.$climaymenoimg->imagen)}}" alt="" width="250px"  class="img-thumbnail">
                                                  @else
                                                            "No hay imagen"
                                                  @endif
                                              </div>
                                          ...
                                          <div class="col-lg-5 col-sm-12 col-md-12 col-xs-12">
                                                ...
                                                <label for="descripcion">Descripción</label>
                                                      <textarea name="descripcion" class="form-control">{{ $climaymenoimg->descripcion }}</textarea>
                                                </div>
                                          </div>
                                      </div>
