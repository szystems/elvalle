                                                                  ...
                                                                  <table class="table table-sm table-striped table-bordered table-condensed table-hover">
                                                                        ...
                                                                        <tbody>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <input type="text" name="presion_arterial" class="form-control text-right" aria-label="Amount (to the nearest dollar)" value="{{ old('presion_arterial') }}" placeholder="0"  required>
                                                                                                <div class="input-group-prepend">
