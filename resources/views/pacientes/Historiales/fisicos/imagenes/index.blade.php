        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{URL::action('FisicoController@index','searchidpaciente='.$paciente->idpaciente)}}"><b><u>Fisico</u></b></a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="card">
                    ...
                    <header class="card-header">
                        <a href="{{URL::action('FisicoController@show',$fisico->idfisico)}}">
                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Regresar a examen fisico">
                                <button class="btn btn-sm btn-info" style="pointer-events: none;" type="button">
                                    <i class="fas fa-reply-all"></i>Regresar a examen fisico
                                </button>
                            </span>
                        </a>
                        ...
                        @if(Auth::user()->tipo_usuario == "Doctor")
                            {!!Form::open(array('url'=>'pacientes/historiales/fisicos/imagenes','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
                            {{Form::token()}}
                            ...
                            <div class="input-group">
                                <div class="col-lg-4 col-sm-12 col-md-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="idfisico" class="form-control" value="{{$fisico->idfisico}}">
                                    </div>
                                </div>
                                    <div class="col-lg-4 col-sm-12 col-md-12 col-xs-12">
                                        <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered table-condensed table-hover">
                                ...
                                @foreach ($fisicoimgs as $imagen)
                                    <tr>
                                        <td>
                                            @if(Auth::user()->tipo_usuario == "Doctor")
                                                <a href="{{URL::action('FisicoImgController@edit',$imagen->idfisico_img)}}">
                                                ...
                                                <a href="" data-target="#modal-eliminar-{{$imagen->idfisico_img}}" data-toggle="modal">
                                        ...
                                        <td align="center">
                                            @if ($imagen->imagen != null)
                                                <img src="{{asset('imagenes/fisicos/'.$imagen->imagen)}}" alt="" width="250px"  class="img-thumbnail">
                                            @else
                                                "No hay imagen"
                                            @endif
                                        </td>
                                    </tr>
                                    @include('pacientes.historiales.fisicos.imagenes.modaleliminar')
                                @endforeach
                            </table>
                        </div>
                    </div>
