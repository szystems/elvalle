<!-- Basic Modals -->
<div class="modal fade" data-backdrop="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="modal-eliminar-{{$incontinencia->idincontinenciau}}">
	{{Form::open(array
		(
			'action' => 'IncontinenciauController@eliminarincontinencia',
			'method' => 'GET',
			'role' => 'form',
		))
	}}
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				Confirme si desea eliminar el estudio de incontinencia urinaria
			</div>
