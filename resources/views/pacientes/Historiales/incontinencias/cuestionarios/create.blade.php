            ...
            <div class="card mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="card">
                              ...
                              <header class="card-header">
                                    <h2 class="h3 card-header-title"><strong>Nuevo Cuestionario: </strong></h2>
                              </header>

                              <div class="card-body">
                                    {!! Form::open(['url' => 'pacientes/historiales/incontinencias/cuestionarios', 'method' => 'POST', 'autocomplete' => 'off']) !!}
                                    {{ Form::token() }}
                                                                              ...
                                                                              <tr>
                                                                                    <td align="left">
                                                                                          <select name="cantidad" class="form-control">
                                                                                                @if (old('cantidad'))
                                                                                                      <option value="{{ old('cantidad') }}" selected>{{ old('cantidad') }}</option>
                                                                              ...
                                                                              <tr>
                                                                                    <td align="left">
                                                                                          <select name="medida" class="form-control">
                                                                                                @if (old('medida'))
                                                                                                      <option value="{{ old('medida') }}" selected>{{ old('medida') }}</option>
