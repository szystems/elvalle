            ...
            <div class="card mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="card">
                              ...
                              <header class="card-header">
                                    <h2 class="h3 card-header-title"><strong>Nueva Sesion de ciclo de silla electromagnetica: </strong></h2>
                              </header>

                              <div class="card-body">
                                    {!! Form::open(['url' => 'pacientes/historiales/sillas/sesiones', 'method' => 'POST', 'autocomplete' => 'off']) !!}
                                    {{ Form::token() }}
                                          ...
                                          <div class="row">
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                                      <div class="form-group">
                                                            <label for="doctor"><h2><u><strong>Datos de nueva sesion de ciclo de silla electromagnetica:</strong></u></h2></label>
                                                      </div>
                                                </div>
                                                                  ...
                                                                  <table class="table table-sm table-striped table-bordered table-condensed table-hover">
                                                                        ...
                                                                        <tbody>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <span class="form-icon-wrapper">
                                                                                                ...
                                                                                                <input readonly type="text" id="datepicker" class="form-control datepicker" name="fecha" value="">
                                                                                          </span>
                                                                                    </td>
                                                                              </tr>
                                                                                    ...
                                                                                    <td align="right">
                                                                                          <span class="form-icon-wrapper">
                                                                                                ...
                                                                                                <select name="tesla" class="form-control">
                                                                                                      @if (old('tesla'))
                                                                                                            <option selected value="{{ old('tesla') }}" selected>{{ old('tesla') }}</option>
                                                                                                      ...
                                                                                                      @else
                                                                                                            <option selected value="33.33">33.33</option>
                                                                                                            <option value="66.66">66.66</option>
                                                                                                            <option value="99.99">99.99</option>
                                                                                                            <option value="133.33">133.33</option>
                                                                                                            <option value="166.66">166.66</option>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <input class="form-control" name="minutos" value="{{ old('minutos') }}" onkeypress="return validarentero(event,this.value)" required>
                                                                                          </div>
                                                                                    </td>
                                                                              </tr>
                                                                              ...
                                                                              <tr>
                                                                                    ...
                                                                                    <td align="left">
                                                                                          <div class="input-group">
                                                                                                <textarea class="form-control" name="observaciones" cols="30" rows="2">{{ old('observaciones') }}</textarea>
                                                                                          </div>
                                                                                    </td>
                                                                              </tr>
