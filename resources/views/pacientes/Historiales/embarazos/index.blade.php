        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                                    <div class="form-group mb-2">
                                        <label for="fecha"></label><font color="orange"></font>FUR:</label>
                                        <span class="form-icon-wrapper">
                                            <span class="form-icon form-icon--right">
                                                <i class="fas fa-calendar-alt form-icon__item"></i>
                                            </span>
                                            <input type="text" id="fur" class="form-control datepicker" name="fur" value="">
                                        </span>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
                                    <div class="form-group mb-2">
                                        <span class="input-group-btn"><br>
                                            <button type="submit" class="btn btn-success">
                                                <i class="far fa-plus-square"></i> Crear Embarazo
                                            </button>
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <h2 class="h3 card-header-title"><strong>Listado de Embarazos: </strong></h2>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{URL::action('EmbarazoController@show',$embarazo->idembarazo)}}">
                                                <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Ver embarazo">
                                        ...
                                        <td align="center"><h5>{{ $embarazo->Doctor}}</h5></td>
                                    </tr>
