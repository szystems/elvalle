            ...
            <div class="card mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="card">
                              ...
                              <header class="card-header">
                                    <h2 class="h3 card-header-title"><strong>Editar cabecera de embarazo: </strong></h2>
                              </header>

                              <div class="card-body">
                                    {!!Form::model($embarazo,['method'=>'PATCH','route'=>['embarazos.update',$embarazo->idembarazo]])!!}
                                    {{Form::token()}}
                                          <div class="row">
                                                ...
                                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                                      <div class="form-group">
                                                            ...
                                                            <input readonly type="text" class="form-control" name="paciente" value="{{ $embarazo->Paciente }}">
                                                            <input type="hidden" class="form-control" name="idpaciente" value="{{ $embarazo->idpaciente }}">
                                                      </div>
                                                </div>
                                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                                      <div class="form-group">
                                                            <label for="estado_civil"><strong>Doctor</strong></label>
                                                            <input readonly type="text" class="form-control" name="doctor" value="{{ $embarazo->Doctor }} ({{ $embarazo->especialidad }})">
                                                            <input type="hidden" class="form-control" name="iddoctor" value="{{ $embarazo->iddoctor }}">
                                                            <input type="hidden" class="form-control" name="idusuario" value="{{ $embarazo->idusuario }}">
                                                      </div>
                                                </div>
                                                <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
                                                      <div class="form-group">
                                                            <label><strong>FUR</strong></label>
                                                            <span class="form-icon-wrapper">
                                                            <span class="form-icon form-icon--right">
                                                                  <i class="fas fa-calendar-alt form-icon__item"></i>
                                                            </span>
                                                ...
                                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                                      <div class="form-group">
                                                            <label><b><u>Seguimiento</u></b></label>
                                                      </div>
                                                </div>
                                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                                      <div class="form-group">
                                                            <label><strong>1er. Trimestre</strong></label>
                                                            <textarea class="form-control" name="trimestre1" id="" cols="30" rows="3">{{ $embarazo->trimestre1 }}</textarea>
                                                      </div>
                                                </div>
                                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                                      <div class="form-group">
                                                            <label><strong>2do. Trimestre</strong></label>
                                                            <textarea class="form-control" name="trimestre2" id="" cols="30" rows="3">{{ $embarazo->trimestre2 }}</textarea>
                                                      </div>
                                                </div>
                                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                                      <div class="form-group">
                                                            <label><strong>3er. Trimestre</strong></label>
                                                            <textarea class="form-control" name="trimestre3" id="" cols="30" rows="3">{{ $embarazo->trimestre3 }}</textarea>
                                                      </div>
                                                </div>
