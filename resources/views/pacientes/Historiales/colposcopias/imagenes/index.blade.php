                ...
                <div class="card">
                    ...
                    <header class="card-header">
                        <a href="{{URL::action('ColposcopiaController@show',$colposcopia->idcolposcopia)}}">
                            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Regresar a examen colposcopia">
                                <button class="btn btn-sm btn-info" style="pointer-events: none;" type="button">
                                    <i class="fas fa-reply-all"></i>Regresar a examen colposcopia
                                </button>
                            </span>
                        </a>
                        ...
                        @if(Auth::user()->tipo_usuario == "Doctor")
                            {!!Form::open(array('url'=>'pacientes/historiales/colposcopias/imagenes','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
                            {{Form::token()}}
                            ...
                            <div class="input-group">
                                <div class="col-lg-4 col-sm-12 col-md-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="idcolposcopia" class="form-control" value="{{$colposcopia->idcolposcopia}}">
                                    </div>
                                </div>
                                    <div class="col-lg-4 col-sm-12 col-md-12 col-xs-12">
                                        <div class="form-group">
                            ...
                            <table class="table table-striped table-bordered table-condensed table-hover">
                                ...
                                @foreach ($colposcopiaimgs as $imagen)
                                    <tr>
                                        <td>
                                            @if(Auth::user()->tipo_usuario == "Doctor")
                                                <a href="{{URL::action('ColposcopiaImgController@edit',$imagen->idcolposcopia_img)}}">
                                                ...
                                                <a href="" data-target="#modal-eliminar-{{$imagen->idcolposcopia_img}}" data-toggle="modal">
                                        ...
                                        <td align="center">
                                            @if ($imagen->imagen != null)
                                                <img src="{{asset('imagenes/colposcopias/'.$imagen->imagen)}}" alt="" width="250px"  class="img-thumbnail">
                                            @else
                                                "No hay imagen"
                                            @endif
                                        </td>
                                    </tr>
                                    @include('pacientes.historiales.colposcopias.imagenes.modaleliminar')
                                @endforeach
                            </table>
                        </div>
                    </div>
